...
class TestVisitorScheduleAPI:
    ...
    def test_get_known_schedule(self, schema_api: APIClient):
        ...
        try:
            ...
            if e.response.status_code == 404:
                pytest.skip("Visitor schedule 11 (Addy) not found in this schema")
            raise
    ...
    @pytest.mark.xfail(reason="Backend always stores 'Active' status regardless of input", strict=False)
